...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:sticky top-0 left-0 z-50 md:z-30 w-64 bg-zinc-950 border-r border-zinc-900 flex flex-col justify-between h-screen select-none transition-transform duration-300 ease-in-out ${
